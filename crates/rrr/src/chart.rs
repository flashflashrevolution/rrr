...
impl Default for NoteRow {
    fn default() -> Self {
        Self { offset: Rational::new(0, 1), notes: Vec::default() }
    }
}
...
impl Default for BpmChange {
    fn default() -> Self {
        Self { bpm: Rational::new(0, 1), beat: 0 }
    }
}
...
impl Chart {
    ...
    pub fn new(beats: &[Beat], bpm_changes: &[BpmChange]) -> Self {
        Self { beats: beats.into(), bpm_changes: bpm_changes.into() }
    }
}
